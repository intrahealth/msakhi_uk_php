$(document).ready(function () {
    ...
    var toggle_open = localStorage.getItem('ma-layout-status');
    if (toggle_open){
        $('#tw-switch').prop('checked', 'checked');
    }else{
        $('#tw-switch').prop('checked', '');
    }
...
$('body').on('change', '#toggle-width input:checkbox', function () {
   ...
   /* if ($(this).is(':checked')) {
        ...
        setTimeout(function () {
            $('#content').removeClass('content-expand').addClass('content-shrink')
            $('#sidebar').removeClass('sidebar-hide').addClass('sidebar-show');
            localStorage.setItem('ma-layout-status', 1);
        }, 100);
    }
    else {
        setTimeout(function () {
            $('#content').removeClass('content-shrink').addClass('content-expand')
            $('#sidebar').removeClass('sidebar-show').addClass('sidebar-hide');
            localStorage.setItem('ma-layout-status', 0);
        }, 100);
    }*/
