...
class Immunization extends Auth_controller {
...
/**
	...
	*/	
	...
	public function index($ImmunizationPDF = ' ')
	{
		...
		$content['immunization_summary'] = $this->Immunization_model->get_immunization_summary();
		...
		$content['subview'] = 'immunization_report';
