...
// }
	...
	// die($query);
		...
		// die($query);
							...
							public function get_children_age_months_zero_to_five_year()
							{
								$query = "SELECT
								a.total as male,
								b.total as female,
							...
							public function get_children_age_months_zero_to_six_months()
							{
								$query = "SELECT
								a.total as male,
								b.total as female,
							...
							public function get_children_age_months_six_to_one_year()
							{
								$query = "SELECT
								a.total as male,
								b.total as female,
							...
							public function get_children_age_months_one_to_two_year()
							{
								$query = "SELECT
								a.total as male,
								b.total as female,
							...
							public function get_children_age_months_two_to_three_year()
							{
								$query = "SELECT
								a.total as male,
								b.total as female,
							...
							public function get_children_age_months_three_to_five_year()
							{
								$query = "SELECT
								a.total as male,
								b.total as female,
							...
							public function get_children_age_months_0_to_5_year()
							{
								$query = "SELECT
								a.total as male,
								b.total as female,
