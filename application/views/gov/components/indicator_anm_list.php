...
<section id="content">
	<div class="panel">
		...
		<div class="panel-heading">
			...
			<a href="<?php echo site_url("gov/indicator_anm_list/$indicator/export_pdf");?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export PDF">
				<i class="fa fa-2x fa-file-pdf-o" id="" name="" style="color: #cc3300; cursor: pointer; margin-right: 20px;" onclick="csv()"></i>
			</a>

			<a href="<?php echo site_url("gov/indicator_anm_list/$indicator/export_csv");?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export Excel">
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					foreach ($anm_list as $anm) {
						// print_r($anm); die();
						?>
						<tr class="link_row" data-href="<?php echo base_url()."gov/indicator_asha_list/".$indicator."/".$anm->ANMCode; ?>">
							<td><?php echo $sno; ?></td>
