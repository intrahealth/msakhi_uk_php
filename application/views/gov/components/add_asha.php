	...
	<script language='javascript'>
		$(document).ready(function(){
			...
			$('#BlockID').change(function(){
				...
				$.post('<?php echo site_url('gov/Ajax/getPhcLists/');?>/'+BlockID, {},
					function(raw){
						$('#PHC_id').html(raw);
					});
			});
			...
			$('#PHC_id').change(function(){
				var PHC_id = $(this).val();
				$.post('<?php echo site_url('gov/Ajax/getSubcenterList');?>/'+PHC_id, {}, function(raw){
			...
			$('#SubCenterID').change(function(){
				...
				$.post('<?php echo site_url('gov/Ajax/getAnmListViaSubcenter');?>/'+SubCenterID, {},
					function(raw){
						$('#ANMID').html(raw);
					});
			});
			...
			$('#ANMCode').change(function(){
				...
				$.post('<?php echo site_url('gov/Ajax/getAnmVillageviaAnmCode');?>/'+ANMCode, {}, function(raw){
