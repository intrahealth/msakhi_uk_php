                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>gov/graph/preg_women_reg_first_trimester" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>gov/graph/one_anc_checkup" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>gov/graph/two_anc_checkup" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>gov/graph/three_anc_checkup" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>gov/graph/four_anc_checkup" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>gov/graph/tt2_booster" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>gov/graph/institutional_delivery" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>gov/graph/newborns_visited_two_or_more_times" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>gov/graph/newborns_visited_three_or_more_times_home_delivery" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>gov/graph/newborns_visited_two_or_more_times_instituional" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>gov/graph/low_birth_weight" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
