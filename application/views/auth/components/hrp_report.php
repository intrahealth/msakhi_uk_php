...
<tr>
  <td>Total HRP cases among the currently pregnant women who are meeting any HRP condition with respect to the current values</td>
  <td><?php  print $hrp_summary['total_hrp_cases_metch_condition'];?></td>    
  <td><?php  print number_format(($hrp_summary['total_hrp_cases_metch_condition'] / $total_pregnant_women) * 100, 2);?></td> 
</tr>

<tr>
  <td>Total HRP cases among the currently pregnant women who were ever identified as HRP due to any HRP condition</td>
