...
<section id="content">
	<div class="panel">
		...
		<div class="panel-heading">
			...
			<a href="<?php echo site_url("admin/indicator_beneficiary_list/$indicator/ASHAID/export_pdf");?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export PDF">
				<i class="fa fa-2x fa-file-pdf-o" id="" name="" style="color: #cc3300; cursor: pointer; margin-right: 20px;" onclick="csv()"></i>
			</a>

			<a href="<?php echo site_url("admin/indicator_beneficiary_list/$indicator/ASHAID/export_csv");?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export Excel">
