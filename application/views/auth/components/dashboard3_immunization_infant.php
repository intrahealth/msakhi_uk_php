...
<section id="content" >
  ...
  <div class="row">
      ...
      <div id="pie-charts" class="dw-item bgm-brown c-white">
        ...
        <div class="dw-item">
          <div class="dwi-header">
            <div class="dwih-title">Proportion of children aged 45 days or more received OPV1</div>
          </div>
    ...
    <div class="col-md-4 col-sm-6">
      <div id="pie-charts" class="dw-item bgm-purple c-white">
        ...
        <div class="dw-item">
          <div class="dwi-header">
            <div class="dwih-title">Proportion of children aged 45 days or more received DPT1</div>
          </div>
    ...
    <div class="col-md-4 col-sm-6">
      <div id="pie-charts" class="dw-item bgm-bluegray c-white">
        ...
        <div class="dw-item">
          <div class="dwi-header">
            <div class="dwih-title">Proportion of children aged 45 days or more received Hepatitis B1</div>
          </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-sm-6">
      <div id="pie-charts" class="dw-item bgm-brown c-white">
        ...
        <div class="dw-item">
          <div class="dwi-header">
            <div class="dwih-title">Proportion of children aged 75 days or more received OPV2</div>
          </div>
    ...
    <div class="col-md-4 col-sm-6">
      <div id="pie-charts" class="dw-item bgm-purple c-white">
        ...
        <div class="dw-item">
          <div class="dwi-header">
            <div class="dwih-title">Proportion of children aged 75 days or more received DPT2</div>
          </div>
    ...
    <div class="col-md-4 col-sm-6">
      <div id="pie-charts" class="dw-item bgm-brown c-white">
        ...
        <div class="dw-item">
          <div class="dwi-header">
            <div class="dwih-title">Proportion of children aged 75 days or more received Hepatitis B2</div>
          </div>
  ...
  <div class="row">
   ...
   <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-bluegray c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title">Proportion of children aged 105 days or more received OPV3</div>
        </div>
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-brown c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title">Proportion of children aged 105 days or more received DPT3</div>
        </div>
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-purple c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title">Proportion of children aged 105 days or more received HepatitisB3</div>
        </div>
...
<div class="row">
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-bluegray c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title">Proportion of children aged 9 months received Measles vaccination</div>
        </div>
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-brown c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title">Proportion of children aged 9 months received Vitamin A</div>
        </div>
