<section id="content">
<?php foreach ($role_permission as $row) { if ($row->Controller == "vhnd_schedule" && $row->Action == "index") { ?>
			...
			<div class="content animate-panel">
				...
				<div class="card">
					...
					<div class="card-header">
						...
						<a href="<?php echo site_url('vhnd_schedule/index/export_pdf');?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export PDF">
					...
					<div class="card-header less-padding">
						...
						<div class="row">
							...
							<div class="col-xs-3">
								...
								<a href="<?php echo site_url("vhnd_schedule");?>" class="btn btn-default btn-block" >Refresh / Reset</a>
							</div>
...
<?php } } ?>
	...
	<script type="text/javascript">
		...
		$('#SubCenterCode').change(function(){
			...
			$.post('<?php echo site_url('Ajax/getanmsubcenter/');?>/'+SubCenterCode, {}, function(raw){
				$('#ANMID').html(raw);
			});
		});
	});
