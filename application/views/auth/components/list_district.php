			...
			<div class="card">													
				...
				<h2>District list <small>List of District </small></h2>
					...
					<?php foreach ($role_permission as $row) {
						...
						<a href="<?php echo site_url("district/add/?" . http_build_query(array(
						...
						<?php foreach ($role_permission as $row) {
							...
							<a href="<?php echo site_url('district/export_pdf'). "/" . $this->input->post('StateCode');?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export PDF">
							...
							<?php foreach ($role_permission as $row) {
								...
								<a href="<?php echo site_url('district/export_csv'). "/" . $this->input->post('StateCode');?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export Excel">
