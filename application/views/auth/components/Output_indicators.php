...
<section id="content" >
  ...
  <?php foreach ($role_permission as $row) { if ($row->Controller == "Output_indicators" && $row->Action == "index") { ?>
  <div class="block-header">
    ...
    <li class="dropdown">
      ...
      <?php foreach ($role_permission as $row) {
        if ($row->Controller == "Process_indicators" && $row->Action == "Export_pdf"){ ?>
        ...
        <?php foreach ($role_permission as $row) {
          if ($row->Controller == "Process_indicators" && $row->Action == "Export_Excel"){ ?>
                ...
                <table class="table table-hover table-condensed table-vmiddle">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $demographic['total_households']['count'];?></td>
                 <!-- <td><?php echo number_format($demographic['total_households']['percent'],1);?></td> -->
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><?php echo $demographic['get_children_age_months_0_to_5_year']['count'];?></td>
                      <td><?php echo number_format($demographic['get_children_age_months_0_to_5_year']['percent'],1);?></td>
                    </tr>
                    <tr>
              ...
              <div class="col-md-6">
                ...
                <table class="table table-hover table-condensed table-vmiddle">
                  ...
                  <tbody>
                    <tr>
                      <td>0-5 years</td>
                      <td><?php echo number_format($get_children_age_months_zero_to_five_year[0]->male);?></td>
                      <td><?php echo $get_children_age_months_zero_to_five_year[0]->female;?></td> 
                      <td><?php echo $get_children_age_months_zero_to_five_year[0]->total;?></td>
                    </tr>
                    <tr>
                      <td>0 months to <=6 months</td>
                      <td><?php echo number_format($get_children_age_months_zero_to_six_months[0]->male);?></td>
                      <td><?php echo number_format($get_children_age_months_zero_to_six_months[0]->female);?></td>
                      <td><?php echo number_format($get_children_age_months_zero_to_six_months[0]->total);?></td>
                    </tr>
                    <tr>
                      <td>More than 6 months to <= 1 year</td>
                      <td><?php echo number_format($get_children_age_months_six_to_one_year[0]->male);?></td>
                      <td><?php echo number_format($get_children_age_months_six_to_one_year[0]->female);?></td>
                      <td><?php echo number_format($get_children_age_months_six_to_one_year[0]->total);?></td>
                    </tr>
                    <tr>
                      <td>> 1 yr to <= 2 yr</td>
                      <td><?php echo number_format($get_children_age_months_one_to_two_year[0]->male);?></td>
                      <td><?php echo number_format($get_children_age_months_one_to_two_year[0]->female);?></td>
                      <td><?php echo number_format($get_children_age_months_one_to_two_year[0]->total);?></td>
                    </tr>
                    <tr>
                      <td>> 2 yr to <= 3 yr</td>
                      <td><?php echo number_format($get_children_age_months_two_to_three_year[0]->male);?></td>
                      <td><?php echo number_format($get_children_age_months_two_to_three_year[0]->female);?></td>
                      <td><?php echo number_format($get_children_age_months_two_to_three_year[0]->total);?></td>
                    </tr>

                    <tr>
                      <td>> 3 yr to <= 5 yr</td>
                      <td><?php echo number_format($get_children_age_months_three_to_five_year[0]->male);?></td>
                      <td><?php echo number_format($get_children_age_months_three_to_five_year[0]->female);?></td>
                      <td><?php echo number_format($get_children_age_months_three_to_five_year[0]->total);?></td>
                    </tr>
                    <!-- <tr>
                      <td>> 3 yr to <= 5 yr</td>
              ...
              <div class="col-md-6">
                <table class="table table-hover table-condensed table-vmiddle">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Currently Married Women</td>
                      <td><?php echo $married['total_married_women']['count'];?></td>
                      <td><?php echo number_format($married['total_married_women']['percent'],1);?></td>
                    </tr>
                    <tr>
                      <td>With no Child</td>
                      <td><?php echo $married['woman_with_no_child']['count'];?></td>
                      <td><?php echo number_format($married['woman_with_no_child']['percent'],1);?></td>
                    </tr>
                    <tr>
                      <td>With 1 Child</td>
                      <td><?php echo $married['woman_with_1_child']['count'];?></td>
                      <td><?php echo number_format($married['woman_with_1_child']['percent'],1);?></td>
                    </tr>
                    <tr>
                      <td>With 2 Children</td>
                      <td><?php echo $married['woman_with_2_child']['count'];?></td>
                      <td><?php echo number_format($married['woman_with_2_child']['percent'],1);?></td>
                    </tr>
                    <tr>
                      <td>With 3 or 3+ Children</td>
                      <td><?php echo $married['woman_with_3_child']['count'];?></td>
                      <td><?php echo number_format($married['woman_with_3_child']['percent'],1);?></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <div class="col-md-6">
                ...
                <table class="table table-hover table-condensed table-vmiddle">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Currently pregnant women</td>
                      <td><?php echo ($pregnent['total_pregnent_women']['count']);?></td>
                      <td><?php echo number_format($pregnent['total_pregnent_women']['percent'],1);?></td>
                    </tr>
                    <tr>
                      <td>With no Child</td>
                      <td><?php echo ($pregnent['pregnent_with_no_child']['count']);?></td>
                      <td><?php echo number_format($pregnent['pregnent_with_no_child']['percent'],1);?></td>
                    </tr>
                    <tr>
                      <td>With 1 Child</td>
                      <td><?php echo ($pregnent['pregnent_with_1_child']['count']);?></td>
                      <td><?php echo number_format($pregnent['pregnent_with_1_child']['percent'],1);?></td>
                    </tr>
                    <tr>
                      <td>With 2 Children</td>
                      <td><?php echo ($pregnent['pregnent_with_2_child']['count']);?></td>
                      <td><?php echo number_format($pregnent['pregnent_with_2_child']['percent'],1);?></td>
                    </tr>
                    <tr>
                      <td>With 3 or 3+ Children</td>
                      <td><?php echo ($pregnent['pregnent_with_3_child']['count']);?></td>
                      <td><?php echo number_format($pregnent['pregnent_with_3_child']['percent'],1);?></td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-3 form-group">
                ...
                <select name="ANM" id="ANM" class="form-control fg-line" onchange="get_asha_list()" style="width: 100%">
              ...
              <div class="col-md-3 form-group">
                ...
                <select name="Asha" id="Asha" class="form-control fg-line" style="width: 100%">
                  <option value="">--select--</option>
  ...
  function makeChartDialog(indicator_id){
    ...
    dialogChart = $('#div_chart_dialog').dialog({
      ...
      open: function(){
        ...
        $.get('<?php echo site_url('Output_indicators/get_indicator_trend');?>/' + indicator_id, function(raw){
