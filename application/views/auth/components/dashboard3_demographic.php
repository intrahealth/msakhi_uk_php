...
<section id="content" >
  ...
  <div class="block-header">
    <h2 style="color: #adadad">Demographic</h2>
      ...
      <div id="pie-charts" class="dw-item bgm-brown c-white">
        ...
        <div class="dw-item">
          <div class="dwi-header">
            <div class="dwih-title text-center" text-center">Total Population</div>
          </div>

          <div class="clearfix"></div>

          <div class="text-center p-20 m-t-25">
            <!-- <div class="easy-pie main-pie" data-percent="<?php echo $fp_block;?>">
          </div> -->
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-purple c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title text-center"">Number of Women 15-49 years</div>
        </div>

        <div class="clearfix"></div>

        <div class="text-center p-20 m-t-25">
           <!--  <div class="easy-pie main-pie" data-percent="<?php echo $p_block;?>">
         </div> -->
 ...
 <div class="col-md-4 col-sm-6">
  <div id="pie-charts" class="dw-item bgm-bluegray c-white">
    ...
    <div class="dw-item">
      <div class="dwi-header">
        <div class="dwih-title text-center"">Number of children 0-6 months</div>

        <div class="clearfix"></div>

        <div class="text-center p-20 m-t-25">
            <!-- <div class="easy-pie main-pie" data-percent="<?php echo $i_block;?>">
          </div> -->
...
<div class="row">
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-brown c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title text-center"">Number of children 6 months-1 year</div>
        </div>
        ...
        <div class="text-center p-20 m-t-25">
          ...
          <div class="percent"><h1 class="text-center"><?php echo $children_age_months_6_12;?></h1></div>
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-purple c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title text-center"">Number of children 0-2 years</div>
        </div>
        ...
        <div class="text-center p-20 m-t-25">
          ...
          <div class="percent"><h1 class="text-center"><?php echo $children_age_months_0_24;?></h1></div>
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-bluegray c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title text-center"">Number of children 1-3 years</div>
        </div>
        ...
        <div class="text-center p-20 m-t-25">
          ...
          <div class="percent"><h1 class="text-center"><?php echo $children_age_months_12_36;?></h1></div>
...
<div class="row">
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-brown c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title text-center"">Number of children 4-6 years</div>
        </div>
        ...
        <div class="text-center p-20 m-t-25">
          ...
          <div class="percent"><h1 class="text-center"><?php echo $children_age_months_48_72;?></h1></div>
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-purple c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title text-center"">Number of children 0-6 years</div>
        </div>
        ...
        <div class="text-center p-20 m-t-25">
          ...
          <div class="percent"><h1 class="text-center"><?php echo $children_age_months_0_72;?></h1></div>
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-bluegray c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title text-center"">Adults aged 35-50 years</div>
        </div>
        ...
        <div class="text-center p-20 m-t-25">
          ...
          <div class="percent"><h1 class="text-center"><?php echo $adults_aged_35_50_years;?></h1></div>
...
<div class="row">
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-brown c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title text-center"">Adults age more than 60 years of age</div>
        </div>
        ...
        <div class="text-center p-20 m-t-25">
          ...
          <div class="percent"><h1 class="text-center"><?php echo $adults_aged_60_years_and_more;?></h1></div>
  ...
  <div class="col-md-4 col-sm-6">
    <div id="pie-charts" class="dw-item bgm-purple c-white">
      ...
      <div class="dw-item">
        <div class="dwi-header">
          <div class="dwih-title text-center"">Total pregnant women in the area</div>
        </div>
        ...
        <div class="text-center p-20 m-t-25">
          ...
          <div class="percent"><h1 class="text-center"><?php echo $total_pregnant_women_in_area;?></h1></div>
