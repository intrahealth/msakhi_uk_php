...
<table width="100%" height="100%">
	<thead>
		<tr>
			...
			<th style="background-color: #005585; color: white;" class="text-center">State Name</th>
		</tr>		
	...
	<?php foreach($State_list as $row){ ?>
						<tr>
							...
							<td style="background-color: #d7d6ca; color:black;"  class="text-center"><?php echo $row->StateName; ?></td>
						</tr>
						<?php } ?>
