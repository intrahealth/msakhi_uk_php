<section id="content">
			...
			<div class="content animate-panel">
				...
				<div class="card">
					...
					<div class="card-header">
						...
						<a href="<?php echo site_url('admin/vhnd_schedule/export_pdf');?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export PDF">
							<i class="fa fa-2x fa-file-pdf-o" id="" name="" style="color: #cc3300; cursor: pointer; margin-right: 20px;" onclick="csv()"></i>
						</a>

						<a href="<?php echo site_url('admin/vhnd_schedule/export_csv');?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export Excel">
					...
					<div class="card-header less-padding">
						...
						<div class="row">
							...
							<div class="col-xs-3">
								...
								<a href="<?php echo site_url("admin/vhnd_schedule");?>" class="btn btn-default btn-block" >Refresh / Reset</a>
							</div>
	...
	<script type="text/javascript">
		...
		$('#SubCenterCode').change(function(){
			...
			$.post('<?php echo site_url('admin/Ajax/getanmsubcenter/');?>/'+SubCenterCode, {}, function(raw){
				$('#ANMID').html(raw);
			});
		});
	});
