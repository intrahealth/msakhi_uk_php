		...
		<div class="content animate-panel">
			...
			<div class="card">
				<div class="card-header">
					...
					<a href="<?php echo site_url('admin/household/familymembers/export_pdf');?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export PDF">
						<i class="fa fa-2x fa-file-pdf-o" id="" name="" style="color: #cc3300; cursor: pointer; margin-right: 20px;" onclick="csv()"></i>
					</a>

					<a href="<?php echo site_url('admin/household/familymembers/export_csv');?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export Excel">
				...
				<div  style="text-align:center;"> 									
					<a href="<?php echo site_url("admin/Household");?>" class="btn btn-info">Back</a>
				</div>
