			...
			<div class="content animate-panel">
				...
				<div class="card">
					<div class="card-header">
						...
						<a href="<?php echo site_url('admin/household_report/export_pdf');?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export PDF">
							<i class="fa fa-2x fa-file-pdf-o" id="" name="" style="color: #cc3300; cursor: pointer; margin-right: 20px;" onclick="csv()"></i>
						</a>

						<a href="<?php echo site_url('admin/household_report/export_csv');?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export Excel">
		...
		<script type="text/javascript">
			$(document).ready(function()
			{
				...
				$("#data-table-command").bootgrid({
					...
					ajax: true,
					url: "<?php echo site_url("admin/Ajax/getHouseHoldReportList");?>"	,
					post: function ()
					{
					...
					formatters: {
						...
						{
							return  "<a href=\"<?php echo site_url('admin/household_report/ashadetails');?>/" + row.ANMCode + "\" type=\"button\" class=\"btn btn-icon command-edit waves-effect waves-circle\" data-row-id=\"" + row.ANMCode +"\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"\" data-original-title= \"View Activities\"><span class=\"zmdi zmdi-view-list\"></span></a>"
						}
					}
