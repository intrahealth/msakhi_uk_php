			...
			<div class="content animate-panel">
				...
				<div class="card">
					...
					<form action="" method="post">
						<div class="row" style="padding-left : 25px;">
							...
							<div class="col-xs-2">
								<a href="<?php echo site_url("admin/track_changes");?>" class="btn btn-default" style="margin-top : 40px;">Clear</a>
							</div>
				...
				<div class="card">
					...
					<div class="card-header">
						...
						<a href="<?php echo site_url('admin/track_changes/export_pdf');?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export PDF">
							<i class="fa fa-2x fa-file-pdf-o" id="" name="" style="color: #cc3300; cursor: pointer; margin-right: 20px;" onclick="csv()"></i>
						</a>

						<a href="<?php echo site_url('admin/track_changes/export_csv');?>" class="pull-right hvr-pulse-grow" id="btn-Preview-Image" data-toggle="tooltip" title="Export Excel">
