            ...
            <form action="" method="post">
                <div class="row">
                    ...
                    <div class="formgroup col-lg-2">
                        <button name="apply_filter" value="apply_filter" class="form-control btn btn-info">Apply Filter</button>
                    </div>

                    <div class="formgroup col-lg-2">
                        <button name="clear_filter"  value="clear_filter" class="form-control btn btn-default">Clear Filter</button>
                    </div>
                </div>
            </form>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>public/graph/preg_women_reg_first_trimester" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><?php echo $prop_one_anc_checkup[0] . '/' . $prop_one_anc_checkup[1]; ?></td>
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>public/graph/one_anc_checkup" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>public/graph/two_anc_checkup" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>public/graph/three_anc_checkup" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>public/graph/four_anc_checkup" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>public/graph/tt2_booster" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>public/graph/institutional_delivery" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>3445</td>
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>public/graph/newborns_visited_two_or_more_times" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>3445</td>
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>public/graph/newborns_visited_three_or_more_times" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>3445</td>
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>public/graph/newborns_visited_two_or_more_times_instituional" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>3445</td>
                                <td class="text-center">
                                    <a href="<?php echo site_url(); ?>public/graph/low_birth_weight" class="btn btn-success">View Graph</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
