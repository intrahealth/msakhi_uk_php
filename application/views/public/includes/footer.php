        ...
        <footer id="footer">
            Copyright &copy; 2016 Intrahealth
        ...
        <script src="<?php echo site_url('common_libs');?>/vendors/bower_components/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
